    ...
    return (
        ...
        <CTabs activeItemKey={2}>
            <CTabList variant="tabs" layout="justified">
                <CTab aria-controls="home-tab-pane" itemKey={1}>Profile</CTab>
                <CTab aria-controls="profile-tab-pane" itemKey={2}>Edit</CTab>
            ...
            <CTabContent>
                ...
                <CTabPanel className="py-3" aria-labelledby="profile-tab-pane" itemKey={2}>
                    ...
                    <CRow className="mb-3">
                        ...
                        <CCol sm={6}>
                            <CFormInput style={{marginTop: 10}} placeholder="New password" type="password" id="inputPassword"/>
                        </CCol>
                        
                        <CCol sm={6}>
                            <CFormInput style={{marginTop: 10}} placeholder= "Repeat password"type="password" id="inputPassword"/>
                        </CCol>
                    

                    <CCol sm={6}>
                        <CFormInput style={{marginTop: 10}} type="text" placeholder="Address" aria-label="default input example"/>
                        <CFormInput style={{marginTop: 10}} type="text" placeholder="Phone Number" aria-label="default input example"/>
                    </CCol>

                    </CRow>

                    <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                        <CButton color="success" className="me-md-2" onClick={() => setVisible(!visible)}>Save changes</CButton>
